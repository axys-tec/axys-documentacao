...
CREATE INDEX IF NOT EXISTS idx_easy_mobile_lead_client_occurred
    ON analytics.easy_mobile_lead (client_uuid, occurred_at DESC) WHERE client_uuid IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_easy_mobile_lead_hub_user_occurred
    ON analytics.easy_mobile_lead (hub_user_uuid, occurred_at DESC) WHERE hub_user_uuid IS NOT NULL;
