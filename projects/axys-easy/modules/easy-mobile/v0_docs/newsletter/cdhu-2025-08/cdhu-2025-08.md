# Axys Newsletter — CDHU, agosto de 2025
...
Números apurados estão em cdhu-2025-08.json. Se um número estiver errado, o problema é de apuração e
...
Das 3.559 composições comparáveis, 1.820 tiveram aumento de custo e 1.339 tiveram redução. A média de +0,22% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,06%.
...
Das 9 composições revisadas, 0 tiveram alteração de coeficiente, 6 passaram a contar com novo insumo e 7 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
