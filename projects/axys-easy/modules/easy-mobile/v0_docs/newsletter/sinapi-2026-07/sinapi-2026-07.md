...
A edição de julho de 2026 apresentou variação média de +0,03% nos custos das composições em SP, ante um IPCA de +0,07% no período. Entre as atualizações da fonte, foram incluídas 127 novas composições, 37 foram inativadas e outras 279 passaram por revisão.
