# Axys Newsletter — FDE, outubro de 2025
...
Números apurados estão em fde-2025-10.json. Se um número estiver errado, o problema é de apuração e
se corrige lá, não reescrevendo a frase aqui.
-->

## lead

A edição de outubro de 2025 apresentou variação média de +0,66% nos custos das composições em SP, acima do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 8 novas composições, 1 foram inativadas e outras 0 passaram por revisão.
...
Das 3.310 composições comparáveis, 1.680 tiveram aumento de custo e 1.112 tiveram redução. A média de +0,66% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,02%.
