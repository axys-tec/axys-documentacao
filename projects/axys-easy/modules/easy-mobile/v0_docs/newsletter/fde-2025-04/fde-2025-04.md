...
A edição de abril de 2025 apresentou variação média de +1,82% nos custos das composições em SP, abaixo do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 0 novas composições, 0 foram inativadas e outras 6 passaram por revisão.
...
Das 6 composições revisadas, 0 tiveram alteração de coeficiente, 0 passaram a contar com novo insumo e 0 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
