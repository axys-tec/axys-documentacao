# Axys Newsletter — SINAPI, dezembro de 2025
...
Números apurados estão em sinapi-2025-12.json. Se um número estiver errado, o problema é de apuração e
...
Fechamento de 2025. Variação acumulada no ano em SP, ao lado dos índices no mesmo período.
