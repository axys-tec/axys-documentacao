...
A edição de agosto de 2025 apresentou variação média de +0,21% nos custos das composições em SP, acima do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 69 novas composições, 19 foram inativadas, 1 foi reativada e outras 91 passaram por revisão.
