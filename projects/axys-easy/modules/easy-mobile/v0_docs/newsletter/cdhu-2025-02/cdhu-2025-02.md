# Axys Newsletter — CDHU, fevereiro de 2025
...
Números apurados estão em cdhu-2025-02.json. Se um número estiver errado, o problema é de apuração e
...
Variação da fonte em SP, regime sem desoneração, contra os índices acumulados no intervalo entre a edição atual e a edição anterior. A taxa Selic passou de 11,25% para 13,25% a.a. no período.
...
Das 3.575 composições comparáveis, 2.406 tiveram aumento de custo e 791 tiveram redução. A média de +1,53% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,69%.
