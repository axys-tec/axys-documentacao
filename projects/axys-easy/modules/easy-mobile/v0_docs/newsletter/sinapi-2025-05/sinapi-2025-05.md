# Axys Newsletter — SINAPI, maio de 2025
...
Números apurados estão em sinapi-2025-05.json. Se um número estiver errado, o problema é de apuração e
...
Das 13 composições revisadas, 13 tiveram alteração de coeficiente, 4 passaram a contar com novo insumo e 0 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
