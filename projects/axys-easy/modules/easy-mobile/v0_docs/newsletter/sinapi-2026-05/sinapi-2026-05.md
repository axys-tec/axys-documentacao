...
A edição de maio de 2026 apresentou variação média de +0,48% nos custos das composições em SP, ante um IPCA de +0,58% no período. Entre as atualizações da fonte, foram incluídas 35 novas composições, nenhuma foi inativada e outras 6 passaram por revisão.
