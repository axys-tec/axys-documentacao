# Axys Newsletter — CDHU, novembro de 2025
...
Números apurados estão em cdhu-2025-11.json. Se um número estiver errado, o problema é de apuração e
...
Das 3.559 composições comparáveis, 1.808 tiveram aumento de custo e 1.384 tiveram redução. A média de +0,30% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,04%.
...
Das 5 composições revisadas, 1 tiveram alteração de coeficiente, 2 passaram a contar com novo insumo e 2 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
