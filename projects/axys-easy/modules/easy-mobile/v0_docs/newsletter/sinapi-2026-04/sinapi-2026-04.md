...
A edição de abril de 2026 apresentou variação média de +0,92% nos custos das composições em SP, acima do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 4 novas composições, 0 foram inativadas e outras 93 passaram por revisão.
...
Das 93 composições revisadas, 93 tiveram alteração de coeficiente, 0 passaram a contar com novo insumo e 0 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
