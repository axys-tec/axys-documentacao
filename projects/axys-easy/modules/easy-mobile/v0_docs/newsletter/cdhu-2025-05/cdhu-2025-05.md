# Axys Newsletter — CDHU, maio de 2025
...
Números apurados estão em cdhu-2025-05.json. Se um número estiver errado, o problema é de apuração e
...
Variação da fonte em SP, regime sem desoneração, contra os índices acumulados no intervalo entre a edição atual e a edição anterior. A taxa Selic passou de 13,25% para 14,75% a.a. no período.
...
Das 3.559 composições comparáveis, 2.989 tiveram aumento de custo e 552 tiveram redução. A média de +2,68% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +2,44%.
...
Das 38 composições revisadas, 1 tiveram alteração de coeficiente, 7 passaram a contar com novo insumo e 2 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
