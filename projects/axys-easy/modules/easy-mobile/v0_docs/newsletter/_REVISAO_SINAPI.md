...
Das 7.796 composições comparáveis, 3.302 tiveram aumento de custo e 2.734 tiveram redução. A média de +0,53% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,00%.
...
**Cobertura desta edição:** 27 UFs e 9.647 composições. Do total publicado, 19,2% das linhas de custo das composições e 29,9% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
Das 7.797 composições comparáveis, 4.855 tiveram aumento de custo e 1.395 tiveram redução. A média de +0,44% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,07%.

**Revisões da edição**

A única composição revisada teve alteração de coeficiente.
...
**Cobertura desta edição:** 27 UFs e 9.653 composições. Do total publicado, 19,2% das linhas de custo das composições e 29,9% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
Das 7.794 composições comparáveis, 3.067 tiveram aumento de custo e 3.131 tiveram redução. A média de -0,08% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,00%.
...
**Cobertura desta edição:** 27 UFs e 9.723 composições. Do total publicado, 19,4% das linhas de custo das composições e 29,5% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
Das 7.834 composições comparáveis, 5.873 tiveram aumento de custo e 1.406 tiveram redução. A média de +1,85% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +1,18%.

**Revisões da edição**

Das 3 composições revisadas, 1 teve alteração de coeficiente, 2 passaram a contar com novo insumo e 2 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
...
Das 7.939 composições comparáveis, 5.374 tiveram aumento de custo e 1.460 tiveram redução. A média de +0,17% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,07%.
...
**Cobertura desta edição:** 27 UFs e 9.783 composições. Do total publicado, 18,7% das linhas de custo das composições e 30,5% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
Das 7.934 composições comparáveis, 3.010 tiveram aumento de custo e 2.586 tiveram redução. A média de +0,57% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,00%.
...
**Cobertura desta edição:** 27 UFs e 9.969 composições. Do total publicado, 19,4% das linhas de custo das composições e 30,1% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
A edição de novembro de 2025 apresentou variação média de +0,04% nos custos das composições em SP, abaixo do IPCA registrado no período. A fonte não alterou o cadastro de composições nesta edição.
...
Das 8.034 composições comparáveis, 3.323 tiveram aumento de custo e 2.254 tiveram redução. A média de +0,04% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,00%.
...
**Cobertura desta edição:** 27 UFs e 9.969 composições. Do total publicado, 19,4% das linhas de custo das composições e 28,8% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
Das 8.027 composições comparáveis, 3.147 tiveram aumento de custo e 2.462 tiveram redução. A média de +0,03% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,00%.
...
**Cobertura desta edição:** 27 UFs e 10.141 composições. Do total publicado, 20,3% das linhas de custo das composições e 29,4% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
Das 8.230 composições comparáveis, 3.556 tiveram aumento de custo e 3.151 tiveram redução. A média de +0,11% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,00%.
...
**Cobertura desta edição:** 27 UFs e 10.360 composições. Do total publicado, 19,7% das linhas de custo das composições e 27,4% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
...
Das 8.242 composições comparáveis, 4.385 tiveram aumento de custo e 2.575 tiveram redução. A média de +0,48% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,07%.
...
**Cobertura desta edição:** 27 UFs e 10.413 composições. Do total publicado, 19,5% das linhas de custo das composições e 26,3% dos preços de insumos foram disponibilizados pela fonte sem preço. Esses percentuais ajudam a dimensionar a cobertura efetiva da edição e a disponibilidade de preços para uso em orçamentos.
