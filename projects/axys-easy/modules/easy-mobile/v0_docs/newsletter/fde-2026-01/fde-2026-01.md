# Axys Newsletter — FDE, janeiro de 2026
...
Números apurados estão em fde-2026-01.json. Se um número estiver errado, o problema é de apuração e
se corrige lá, não reescrevendo a frase aqui.
-->

## lead

A edição de janeiro de 2026 apresentou variação média de +0,48% nos custos das composições em SP, abaixo do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 15 novas composições, 20 foram inativadas e outras 0 passaram por revisão.
...
Das 3.298 composições comparáveis, 1.994 tiveram aumento de custo e 811 tiveram redução. A média de +0,48% é o resultado desse balanço, não o comportamento típico. A mediana das variações ficou em +0,13%.
