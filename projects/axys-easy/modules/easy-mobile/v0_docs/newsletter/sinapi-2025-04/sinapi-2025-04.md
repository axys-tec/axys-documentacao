...
A edição de abril de 2025 apresentou variação média de +0,27% nos custos das composições em SP, abaixo do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 33 novas composições, 0 foram inativadas e outras 704 passaram por revisão.
