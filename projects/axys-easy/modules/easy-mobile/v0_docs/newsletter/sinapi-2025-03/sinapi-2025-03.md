# Axys Newsletter — SINAPI, março de 2025
...
Números apurados estão em sinapi-2025-03.json. Se um número estiver errado, o problema é de apuração e
se corrige lá, não reescrevendo a frase aqui.
-->

## lead

A edição de março de 2025 apresentou variação média de +0,44% nos custos das composições em SP, abaixo do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 6 novas composições, 0 foram inativadas e outras 1 passaram por revisão.
...
Das 1 composições revisadas, 1 tiveram alteração de coeficiente, 0 passaram a contar com novo insumo e 0 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
