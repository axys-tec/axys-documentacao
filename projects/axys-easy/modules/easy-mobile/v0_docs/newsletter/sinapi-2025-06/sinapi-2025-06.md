...
A edição de junho de 2025 apresentou variação média de +1,85% nos custos das composições em SP, acima do IPCA registrado no período. A fonte revisou 3 composições nesta edição, sem incluir ou inativar nenhuma.
