# Axys Newsletter — SINAPI, junho de 2025
...
Números apurados estão em sinapi-2025-06.json. Se um número estiver errado, o problema é de apuração e
se corrige lá, não reescrevendo a frase aqui.
-->

## lead

A edição de junho de 2025 apresentou variação média de +1,85% nos custos das composições em SP, acima do IPCA registrado no período. Entre as atualizações da fonte, foram incluídas 0 novas composições, 0 foram inativadas e outras 3 passaram por revisão.
...
Das 3 composições revisadas, 1 tiveram alteração de coeficiente, 2 passaram a contar com novo insumo e 2 tiveram insumo removido. Uma mesma composição pode figurar em mais de uma categoria.
